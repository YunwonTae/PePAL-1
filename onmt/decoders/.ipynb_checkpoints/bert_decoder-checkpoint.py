...
class MyBertEmbeddings(nn.Module):
    ...
    """
    def __init__(self, bert_embeddings, token_type='A', opt=None):
    ...
    def forward(self, input_ids, token_type_ids=None, step=None, user_ids=None):
...
class BERTDecoder(TransformerDecoder):
    ...
    def __init__(self, copy_attn, vocab_size, pad_idx,
                 init_context=False, token_type='A', opt=None):
    ...
    def from_opt(cls, opt, embeddings):
        ...
        return cls(
            ...
            opt.bert_decoder_token_type, opt)

    def forward(self, tgt, memory_bank, memory_lengths=None, step=None, uid=None):
        """
        ...
        emb = self.embeddings(tgt_words, step=step, user_ids=uid)
    ...
    def initialize_bert(self, bert_type):
        ...
        self.embeddings = MyBertEmbeddings(bert.embeddings, self.token_type, self.opt)
