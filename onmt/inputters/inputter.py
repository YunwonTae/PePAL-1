...
def get_fields(
    ...
    # uid_field_kwargs = {"n_feats": n_uid_feats,
    #                     "include_lengths": False,
    #                     "base_name": "uid"}
    
    # fields["uid"] = fields_getters["text"](**uid_field_kwargs)
    
    indices = Field(use_vocab=False, dtype=torch.long, sequential=False)
    fields["indices"] = indices

    indices = Field(use_vocab=False, dtype=torch.long, sequential=False, preprocessing=prep)
    fields["uid"] = indices
    fields["dom"] = indices
